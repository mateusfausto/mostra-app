      ...
      <main className="max-w-[480px] mx-auto px-4 pt-6 pb-28">
        ...
        {loading ? (
          ...
          <div className="space-y-3">
            {anuncios.map(a => (
              <div key={a.id} className="bg-white rounded-[2px] shadow-sm hover:shadow-md transition-shadow overflow-visible">
                {/* Top: imagem + info */}
                <div style={{ display: 'flex', gap: '12px', padding: '16px', paddingBottom: '0' }}>
                  <div className="relative flex-shrink-0 rounded-[2px] overflow-hidden bg-warm" style={{ width: '70px', height: '70px' }}>
                    {a.fotos?.[0] && (
                  ...
                  <div style={{ flex: 1, minWidth: 0 }}>
                    ...
                    <p className="font-dm text-[11px] text-muted" style={{ marginTop: '2px' }}>
                      R$ {formatMoney(a.preco)} · {catLabel[a.categoria] ?? a.categoria}
                    </p>
                    <p className="font-dm text-[11px] text-muted" style={{ marginTop: '4px' }}>
                ...
                <div style={{ padding: '12px 16px 16px' }}>
                  {a.vendedor_whatsapp && (
                    <a href={`https://wa.me/${a.vendedor_whatsapp.replace(/\D/g, '')}`}
                      ...
                      className="font-dm text-[10px] text-[#25D366] hover:text-[#20bd5a] transition-colors"
                  ...
                  <button
                    type="button"
                    onClick={(e) => { e.stopPropagation(); setSelectedAnuncio(a); }}
                    style={{
                      display: 'block',
                      width: '100%',
                      padding: '10px 0',
